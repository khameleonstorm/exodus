...
import { IoStatsChartOutline, IoStatsChart, IoWallet, IoWalletOutline } from 'react-icons/io5'
  ...
  return (authIsReady &&
    <div className={styles.container}>
        ...
        <div className={styles.links}>
          ...
          {(page === "withdraw") ?
          <div className={styles.active}>
            <IoWalletOutline onClick={() => navigate("/dashboard/withdraw")} className={styles.menuIcon}/> 
            <p onClick={() => navigate("/dashboard/withdraw")}>Withdraw</p>
          </div> :
          <div>
            <IoWallet onClick={() => navigate("/dashboard/withdraw")} className={styles.menuIcon}/> 
            <p onClick={() => navigate("/dashboard/withdraw")}>Withdraw</p>
          </div>
          }
