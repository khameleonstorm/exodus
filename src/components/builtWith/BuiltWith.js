    ...
    <div className={styles.container}>
      <div className={styles.left}>
        <div className={styles.leftTextWrapper}>
          ...
          <h1 className={styles.subtitle1}>EXODUS DASHBOARD</h1>
          ...
          <p className={styles.subtitle3}>Best Trading Platform. <span>→</span></p>
        </div>
      ...
      <div className={styles.right}>
        <div className={styles.text}>
          ...
          <p className={styles.best}>Best Trading Platform. <span>→</span></p>
        </div>
      </div>
    </div> 
  )
